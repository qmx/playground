...
<head>
  ...
  <link rel="stylesheet" href="me.qmx.uf.PlaygroundShowcase/patternfly/dist/css/patternfly.min.css">
</head>

<body>
<span id="badge">
  <img src="me.qmx.uf.PlaygroundShowcase/images/uf_logo.png" alt="UberFire Logo" title="Powered By Uberfire"/>
</span>
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <div id="brand">
        <img src="me.qmx.uf.PlaygroundShowcase/images/uf.png" alt="Uberfire UI Framework">
      </div>
    </div>
